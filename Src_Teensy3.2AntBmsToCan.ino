...
uint16_t  chargecurrent = 500; //max charge current in 0.1A
uint16_t  discurrent = 750; // max discharge current in 0.1A
uint16_t  MaxCellVoltage = 2800; //max cell voltage in mv
uint16_t  ChargeVsetpoint = 2800;//  
